...
// Instead of hardcoding credentials, retrieve them from a secure location
var username = getUsernameFromSecureLocation();
var password = getPasswordFromSecureLocation();

function getUsernameFromSecureLocation() {
    // Assuming you're using some server-side logic to fetch the username
    // You can make an AJAX request to your server to retrieve the username
    // For example:
    return fetch('/api/getUsername')
        ...
        .catch(error => {
            ...
            // Handle the error gracefully or throw it further if needed
            throw error;
        });
}

function getPasswordFromSecureLocation() {
    // Assuming you're using some server-side logic to fetch the password
    // You can make an AJAX request to your server to retrieve the password
    // For example:
    return fetch('/api/getPassword')
        .then(response => {
            if (!response.ok) {
