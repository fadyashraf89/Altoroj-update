...
<div id="wrapper" style="width: 99%;">
    ...
    <td valign="top" colspan="3" class="bb">
		...
		<% } else {%>
			 However, the email you gave is incorrect (<%= StringEscapeUtils.escapeHtml(ServletUtil.sanitzieHtmlWithRegex(email.toLowerCase())) %>), and you will not receive a response.
		<% }%>
		</p>
