		...
		<div class="fl" style="width: 99%;">
			...
			<%
				...
				if (content != null && !content.equalsIgnoreCase("customize.jsp")) {
					// Check if the content is a relative path or belongs to the application's domain
			...
			<form method="post">
				<p>
					Current Language: <%= org.owasp.encoder.Encode.forHtmlAttribute(request.getParameter("lang") == null ? "" : request.getParameter("lang")) %>
				</p>
