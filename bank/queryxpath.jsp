...
<div id="wrapper" style="width: 99%;">
    ...
    <td valign="top" colspan="3" class="bb">
        ...
        <div class="fl" style="width: 99%;">
            ...
            <form id="QueryXpath" method="get"
                  action="<%= org.owasp.encoder.Encode.forHtmlAttribute(request.getRequestURL().toString()) %>">
                Search our news articles database
                <br/><br/>
                <input type="hidden" id=content" name="content" value="queryxpath.jsp"/>
                <input type="text" id="query" name="query" width=450
                       value="<%= org.owasp.encoder.Encode.forHtmlAttribute(request.getParameter("query") == null ? "Enter title (e.g. Watchfire)" : request.getParameter("query")) %>"/>
                    ...
                    if (request.getParameter("query") != null) {
                        ...
                        if (results == null)
                            ...
                            for (String result : results)
                                out.println(org.owasp.encoder.Encode.forHtml(result) + "<br/>");
                        }
                    }
                %>
