...
<div id="wrapper" style="width: 99%;">
    ...
    <td valign="top" colspan="3" class="bb">
		...
		<script type="text/javascript">
			...
			<form id="Form1" name="Form1" method="post" action="showTransactions" onsubmit="return (confirminput(Form1));">
				<table border="0" style="padding-bottom:10px;">
					<tr>
						...
						<td>
							<input id="startDate" name="startDate" type="text" value="<%= org.owasp.encoder.Encode.forHtmlAttribute(request.getParameter("startDate") == null ? "" : request.getParameter("startDate")) %>"/><br /><span class="credit">yyyy-mm-dd</span>
						</td>
						<td valign="top">Before</td>
						<td>
							<input name="endDate" id="endDate" type="text" value="<%= org.owasp.encoder.Encode.forHtmlAttribute(request.getParameter("endDate") == null ? "" : request.getParameter("endDate")) %>"/><br /><span class="credit">yyyy-mm-dd</span>
						</td>
			...
			<tr>
				<td><%= org.owasp.encoder.Encode.forHtml(transactions[i].getTransactionId()) %></td>
				<td><%= org.owasp.encoder.Encode.forHtml(date) %></td>
				<td><%= org.owasp.encoder.Encode.forHtml(transactions[i].getAccountId()) %></td>
				<td><%= org.owasp.encoder.Encode.forHtml(transactions[i].getTransactionType()) %></td>
				<td align="right"><%= org.owasp.encoder.Encode.forHtml(amount) %></td>
			</tr>
			<% } %>
		<tr>
